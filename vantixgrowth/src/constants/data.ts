...
export const CASE_STUDIES: CaseStudy[] = [
  {
    id: 'case-01',
    number: '01',
    client: 'Fintech infrastructure co.',
    metric: '3.1M',
    label: 'views in 90 days from a standing start',
  ...
  },
  {
    ...
    metric: '2×',
    label: 'qualified demo requests in one quarter',
...
export const METHOD_STEPS: MethodStep[] = [
  {
    number: '01',
    title: 'Understand',
    description: 'We learn your product, your buyer, and what actually moves them — before a single frame is shot.',
  },
  {
    number: '02',
    title: 'Script & Direct',
    description: 'Senior storytellers turn expertise into narrative. Every piece is directed, not assembled.',
  },
  {
    number: '03',
    title: 'Produce',
    description: 'On-location shoots — we fly to you — plus editing from people who understand story better than anyone in the segment.',
  },
  {
    number: '04',
    title: 'Report & Compound',
    description: 'Monthly proof of impact on the brand and pipeline. We double down on what works, and the engine compounds.',
  },
];
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    author: '[ Placeholder ]',
    role: 'VP Marketing, Fintech infra co.',
    alignRight: false,
  },
  {
...
export const COMPARISON_ROWS: ComparisonRow[] = [
  { capability: 'Short-form content',         basic: 'yes', premium: 'yes',    studio: 'yes'    },
  { capability: 'Long-form content (YouTube)', basic: '',    premium: 'yes',    studio: 'yes'    },
  { capability: 'Scripting',                  basic: 'yes', premium: 'yes',    studio: 'yes'    },
  { capability: 'Shooting (on location)',      basic: '',    premium: '',       studio: 'yes'    },
  { capability: 'Carousels (X / IG / LinkedIn)', basic: '', premium: 'yes',    studio: 'yes'    },
  { capability: 'Monthly sales-impact report', basic: 'yes', premium: 'yes',   studio: 'yes'    },
  { capability: 'Platform management',         basic: '1',   premium: 'multi',  studio: 'all'    },
  ...
  { capability: 'Clipping',                   basic: 'yes', premium: 'yes',    studio: 'yes'    },
