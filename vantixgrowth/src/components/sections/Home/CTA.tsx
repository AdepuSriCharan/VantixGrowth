    ...
    <section ref={containerRef as any} data-theme="indigo" data-screen-label="Final CTA" className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        <h2 className={styles.headline}>
          <span data-reveal-line className={styles.line}>We take a limited number</span>
          <span data-reveal-line className={styles.line}>of partners at a time.</span>
          <span data-reveal-line className={styles.line}>If the fit's right, <span className={styles.accent}>let's build</span>.</span>
        </h2>
