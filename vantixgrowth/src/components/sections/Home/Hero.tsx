...
// Decorative hand-drawn quotation mark. `flip` mirrors it for the closing side.
// Each tick is a mostly-straight multi-segment line (a few slight kinks
// instead of a clean arc) plus a faint offset "second pass" stroke, so it
// reads as two quick pen strokes rather than a drawn comma.
function QuoteMark({ drawn, flip = false, rotate = 0 }: { drawn: boolean; flip?: boolean; rotate?: number }) {
  const strokeA = 'M8 5 L7.7 14 L8.25 23.5 L7.85 33 L8.15 43';
  const strokeB = 'M9.6 6 L9.3 15 L9.7 24.5 L9.35 34 L9.55 42.5';
    ...
    >
      <g>
        <path
          ...
          strokeWidth="1.1"
          strokeLinecap="round"
          className={`${styles.quotePath} ${styles.quotePathGhost} ${drawn ? styles.quotePathDrawn : ''}`}
        />
        <path
          d={strokeA}
          pathLength={1}
          ...
          strokeWidth="1.8"
          strokeLinecap="round"
          className={`${styles.quotePath} ${drawn ? styles.quotePathDrawn : ''}`}
        />
      </g>
      <g transform="translate(12 0)">
        <path
          ...
          strokeWidth="1.1"
          strokeLinecap="round"
          className={`${styles.quotePath} ${styles.quotePathGhost} ${styles.quotePathDelayed} ${drawn ? styles.quotePathDrawn : ''}`}
        />
        <path
          d={strokeA}
          pathLength={1}
          ...
          strokeWidth="1.8"
          strokeLinecap="round"
          className={`${styles.quotePath} ${styles.quotePathDelayed} ${drawn ? styles.quotePathDrawn : ''}`}
        />
      </g>
    </svg>
  );
      ...
      <div className={styles.container}>
        ...
        <h1 className={headlineClass}>
          <span className={styles.quoteOpen} aria-hidden="true">
            <QuoteMark drawn={quotesDrawn} rotate={-7} />
          </span>
          ...
          <span className={styles.lineWrap}>
            ...
            <span className={styles.lineOverlay} aria-hidden="true">
              ...
              <span className={styles.quoteClose}>
                <QuoteMark drawn={quotesDrawn} flip rotate={5} />
              </span>
            </span>
        ...
        <div data-reveal className={styles.statsRow}>
          <div className={styles.statItem}>
            ...
            <span className={styles.statText}>
              <span className={styles.statValue}>190M+</span>
              <span className={styles.statLabel}>views generated</span>
            </span>
          </div>
          <div className={styles.statItem}>
            ...
            <span className={styles.statText}>
              ...
              <span className={styles.statLabel}>of brand building</span>
            </span>
          </div>
          <div className={styles.statItem}>
