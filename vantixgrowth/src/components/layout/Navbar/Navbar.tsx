  ...
  if (isContact) {
    return (
      <nav className={styles.navContact} data-nav>
        <Link to="/" className={styles.brand} ref={logoRef as any} data-cursor="" data-magnetic>
        ...
        <div className={styles.linksContainer}>
          <Link to="/work" className={styles.linkContact} data-cursor="">Work</Link>
          <Link to="/services" className={styles.linkContact} data-cursor="">Services</Link>
          <Link to="/about" className={styles.linkContact} data-cursor="">About</Link>
        </div>
      </nav>
    );
  }
